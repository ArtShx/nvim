...
_G.packer_plugins = {
  ...
  ["darkplus.nvim"] = {
    loaded = true,
    path = "/home/arthur/.local/share/nvim/site/pack/packer/start/darkplus.nvim",
  ...
  ["none-ls.nvim"] = {
    loaded = true,
    path = "/home/arthur/.local/share/nvim/site/pack/packer/start/none-ls.nvim",
  ...
  ["vim-bbye"] = {
    loaded = true,
    path = "/home/arthur/.local/share/nvim/site/pack/packer/start/vim-bbye",
